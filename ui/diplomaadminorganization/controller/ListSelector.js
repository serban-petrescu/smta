sap.ui.define([
	...
	return BaseObject.extend("diploma.admin.organization.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias diploma.admin.organization.model.ListSelector
		 */
		 ...
		 * @return {diploma.admin.organization.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
